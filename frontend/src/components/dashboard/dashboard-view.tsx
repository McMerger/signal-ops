                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-3xl font-bold tracking-tight text-white font-mono">
                                TERMINAL<span className="text-sky-500">.01</span>
                            </h1>
                            <p className="text-zinc-400 font-mono text-sm mt-1 flex items-center gap-2">
                                <span className={`w-2 h-2 rounded-full ${isConnected ? "bg-emerald-500 animate-pulse" : "bg-rose-500"}`} />
                                {isConnected ? "SYSTEM ONLINE" : "SYSTEM DISCONNECTED"}
                            </p>
                        </div>
                    </div>
                ...
                <motion.div variants={item} className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                    <GlassCard className="p-6 border-sky-500/20 bg-sky-950/10">
                        <div className="flex items-center justify-between mb-4">
                            <span className="text-xs font-mono text-sky-400 tracking-wider">TOTAL_BALANCE</span>
                            <Wallet className="h-5 w-5 text-sky-400" />
                        </div>
                        <div>
                            <div className="text-3xl font-bold text-white font-mono tracking-tight flex items-baseline">
                            ...
                            <span className={`mt-1 text-xs flex items-center inline-flex font-mono px-2 py-0.5 rounded ${dashboardData.balanceChange >= 0 ? 'text-emerald-400 bg-emerald-500/10' : 'text-rose-400 bg-rose-500/10'}`}>
